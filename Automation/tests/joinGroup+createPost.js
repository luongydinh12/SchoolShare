...
module.exports = {
    ...
    'Test School Share Login' : function (client) {
      client
        ...
        .pause(500)
        .click('#root > div > div:nth-child(2) > div:nth-child(3) > div > button:nth-child(2)')
        .pause(1000)
        .assert.visible('input[id=text]')
        .setValue('input[id=text]', randomDescription)
        .pause(1000)
        .click('#root > div > div:nth-child(2) > div:nth-child(3) > div > div.row > div.col.l9 > div > form > button')
        .pause(5000)
        .end();
    }
  };